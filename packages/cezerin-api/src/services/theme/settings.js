...
const SETTINGS_FILE = path.resolve('../cezerin-theme/settings/settings.json');
const SETTINGS_SCHEMA_FILE = path.resolve(`../cezerin-theme/settings/${serverSettings.language}.json`);
const SETTINGS_SCHEMA_FILE_EN = path.resolve('../cezerin-theme/settings/en.json');
