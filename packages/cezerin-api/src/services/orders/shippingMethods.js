...
class ShippingMethodsService {
  ...
  getMethods(params = {}) {
    return this.getFilter(params).then(filter => ShippingMethodsLightService.getMethods(filter));
  }
  ...
  async deleteMethod(id) {
    ...
    const methodObjectID = new ObjectID(id);
    const deleteResponse = await db.collection('shippingMethods').deleteOne({ _id: methodObjectID });
