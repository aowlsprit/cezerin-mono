...
export class App extends React.Component {
  ...
  updateSettings = () => {
    ...
    const htmlCode =
      appId && appId.length > 0 ? FACEBOOK_CODE.replace(/YOUR_APP_ID/g, appId).replace(/YOUR_LOCALE/g, locale) : '';
    ...
    return (
      <div>
        ...
        <div style={{ textAlign: 'right' }}>
          <RaisedButton label={messages.save} primary disabled={false} onClick={this.updateSettings} />
        </div>
      </div>
    );
  }
