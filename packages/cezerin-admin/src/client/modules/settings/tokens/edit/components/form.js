...
class EditTokenForm extends React.Component {
  ...
  render() {
    const { handleSubmit, pristine, submitting, initialValues, tokenId, newToken, onDelete } = this.props;
        ...
        <form onSubmit={handleSubmit}>
          <Paper className="paper-box" zDepth={1}>
            <div className={style.innerBox}>
              <Field name="name" component={TextField} floatingLabelText={messages.settings_tokenName} fullWidth />
              <Field
                name="email"
                component={TextField}
