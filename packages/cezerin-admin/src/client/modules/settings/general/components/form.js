          ...
          <div className={style.innerBox}>
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={SelectField} autoWidth fullWidth name="currency_code">
                  {currencyItems}
                </Field>
              </div>
            </div>
            ...
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={TextField} fullWidth name="product_fields" placeholder="id,path,name,price, ..." />
              </div>
            </div>
            ...
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={TextField} fullWidth name="products_limit" type="number" placeholder="30" />
              </div>
            </div>
            ...
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={SelectField} autoWidth fullWidth name="default_shipping_country">
                  {countryItems}
                </Field>
              </div>
            </div>
            ...
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={TextField} fullWidth name="domain" placeholder="https://domain.com" />
              </div>
            </div>
            ...
            <div className="row between-xs middle-xs">
              ...
              <div className="col-xs-12 col-sm-6">
                <Field component={TextField} fullWidth name="order_confirmation_copy_to" />
              </div>
            </div>
          </div>
