...
class EditWebhookForm extends React.Component {
  ...
  render() {
    const { handleSubmit, pristine, submitting, initialValues, webhookId } = this.props;
          ...
          <Paper className="paper-box" zDepth={1}>
            <div className={style.innerBox}>
              <Field
                ...
                multiLine
              />
              <Field name="url" component={TextField} floatingLabelText="URL" fullWidth />
              <Field name="secret" component={TextField} floatingLabelText={messages.webhookSecret} fullWidth />
