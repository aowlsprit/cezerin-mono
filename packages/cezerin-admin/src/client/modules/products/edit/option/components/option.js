        ...
        <form onSubmit={handleSubmit}>
          <Paper className="paper-box" zDepth={1}>
            <div className={style.innerBox}>
              <Field name="name" component={TextField} floatingLabelText={messages.optionName} fullWidth />
              <div className="row">
            ...
            <div className="buttons-box">
              <RaisedButton label={messages.actions_delete} secondary onClick={deleteOption} />
              <FlatButton
