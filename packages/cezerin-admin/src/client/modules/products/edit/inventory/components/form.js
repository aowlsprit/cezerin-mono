...
const asyncValidate = values =>
  Promise.all([slugExists(values), skuExists(values)]).then(([isSlugExists, isSkuExists]) => {
    const errors = {};
      ...
      <div className={style.innerBox}>
        <div className="row" style={{ marginBottom: 50 }}>
          ...
          <div className="col-xs-5 col-xs-offset-2">
            ...
            <Field name="sku" component={TextField} floatingLabelText={messages.products_sku} fullWidth />
