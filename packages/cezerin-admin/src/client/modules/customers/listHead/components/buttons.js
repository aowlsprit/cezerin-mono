...
export default class Buttons extends React.Component {
  ...
  render() {
    ...
    const actionsSetGroup = [
      <FlatButton label={messages.cancel} onClick={this.closeSetGroup} style={{ marginRight: 10 }} />,
      <FlatButton label={messages.save} primary keyboardFocused onClick={this.saveSetGroup} />
    ];
      ...
      <span>
        ...
        {selectedCount > 0 && (
          <span>
            ...
            >
              <GroupSelect onSelect={this.selectSetGroup} selectedId={this.state.groupId} showRoot showAll={false} />
            </Dialog>
          </span>
        )}
      </span>
