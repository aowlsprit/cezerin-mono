...
const Address = ({ address }) => (
  <div className={style.address}>
    ...
    <div>
      {address.city}, {address.state && address.state.length > 0 ? `${address.state}, ` : ''}
      {address.postal_code}
    </div>
          ...
          <div className="row middle-xs">
            ...
            <div className="col-xs-2">
              <IconMenu iconButtonElement={iconButtonElement}>
                ...
                <MenuItem onClick={this.handleSetDefaultBillingAddress} disabled={address.default_billing === true}>
                  {messages.setDefaultBillingAddress}
                </MenuItem>
                <MenuItem onClick={this.handleSetDefaultShippingAddress} disabled={address.default_shipping === true}>
