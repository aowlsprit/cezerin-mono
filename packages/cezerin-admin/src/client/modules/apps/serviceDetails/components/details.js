  ...
  render() {
    ...
    return (
      <div className={`${style.detailsContainer} scroll col-full-height`}>
        ...
        />
        {serviceError && <div style={{ color: '#FC3246', fontSize: '24px', margin: '30px' }}>Service error</div>}
        ...
        {service && service.enabled && serviceLogs && serviceLogs.length > 0 && <ServiceLogs logs={serviceLogs} />}
      </div>
    );
  }
}
