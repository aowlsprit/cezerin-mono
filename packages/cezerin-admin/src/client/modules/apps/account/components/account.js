    ...
    >
      <Paper style={{ margin: '0px 20px' }} zDepth={1}>
        <div style={{ padding: '10px 30px 30px 30px' }}>
          ...
          <div>
            <Field component={TextField} fullWidth name="shop_url" floatingLabelText={messages.shopUrl} />
          </div>
          <div>
            <Field component={TextField} fullWidth name="admin_url" floatingLabelText={messages.adminUrl} />
          </div>
          <Field
