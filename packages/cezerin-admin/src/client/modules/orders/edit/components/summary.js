      ...
      <Paper className="paper-box" zDepth={1}>
        <div className={style.innerBox}>
          ...
          <div style={{ marginTop: 20 }}>
            {allowEdit && <RaisedButton label="Edit" style={{ marginRight: 15 }} onClick={this.showSummaryEdit} />}
            {isDraft && (
              <RaisedButton label={messages.placeOrder} primary onClick={onCheckout} disabled={processingCheckout} />
            )}
          </div>
