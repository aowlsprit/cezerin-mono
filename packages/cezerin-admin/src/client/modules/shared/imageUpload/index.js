  ...
  render() {
    ...
    let htmlPreview = (
      <div className={style.noImage}>
        <FontIcon style={{ fontSize: 90, color: '#cccccc' }} className="material-icons">
          photo_camera
        </FontIcon>
    ...
    return (
      <Paper zDepth={1} rounded={false} style={{ width: 200 }}>
        ...
        <div className={style.footer}>
          ...
          {hasPreview && (
            <IconButton touch tooltip={messages.actions_delete} onClick={this.onDelete} tooltipPosition="top-right">
              <FontIcon color="rgba(0,0,0,0.5)" className="material-icons">
                delete
              </FontIcon>
            </IconButton>
