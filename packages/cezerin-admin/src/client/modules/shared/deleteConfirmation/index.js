...
export default class ConfirmationDialog extends React.Component {
  ...
  render() {
    ...
    const actions = [
      <FlatButton label={messages.cancel} onClick={this.handleCancel} style={{ marginRight: 10 }} />,
      <FlatButton label={messages.actions_delete} primary keyboardFocused onClick={this.handleDelete} />
    ];
